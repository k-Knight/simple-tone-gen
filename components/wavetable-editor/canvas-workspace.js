            ...
            <div class="grid grid-cols-1 md:grid-cols-12 bg-zinc-900/40">
                <div class="md:col-span-4 p-4 border-b md:border-b-0 md:border-r border-zinc-800 space-y-4 flex flex-col justify-between bg-zinc-900/10">
                    ...
                    <div class="grid grid-cols-2 gap-2 pt-3 border-t border-zinc-800/40">
                        <button id="snapEdgesBtn" class="px-2 py-1.5 border border-amber-950/80 hover:border-amber-700 bg-amber-950/20 hover:bg-amber-950/50 text-amber-400 hover:text-amber-300 rounded-lg font-bold transition-all text-center cursor-pointer text-[10px] uppercase shadow-sm">
                            Zero Edges
                        </button>
